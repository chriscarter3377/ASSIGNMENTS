...
def fetch_data(zip=None, city=None):
    ...
    apiid = "18c03c07ad20bb0fc505e122c55cb9e7"
...
#this method shows teh result in readable for,
...
#main method , main drive code of the program,

def main():

    #until the user exists keep running the code
